...
#define EAP_ANONYMOUS_IDENTITY "anonymous@ufsc.br" //anonymous@example.com, or you can use also nickname@example.com
#define EAP_IDENTITY "vinicius.delatore@ufsc.br" //nickname@example.com, at some organizations should work nickname only without realm, but it is not recommended
#define EAP_PASSWORD "159Martins" //password for eduroam account
...
void setup() {
  ...
  WiFi.begin(ssid, EAP_ANONYMOUS_IDENTITY, EAP_IDENTITY, EAP_PASSWORD, test_root_ca); //with CERTIFICATE
